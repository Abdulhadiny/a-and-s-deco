...
export default async function DashboardLayout({
  ...
  return (
    <SidebarProvider>
      <div className="flex h-screen overflow-hidden bg-zinc-950 text-zinc-100 selection:bg-primary/20 selection:text-primary">
        ...
        <div className="relative flex flex-1 flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto bg-zinc-900/50 p-4 md:p-6 lg:p-8">
